...
* **Helper Functions**: `get_dataset()` to load the training/test data, `list_models()` to see available models, and `shap_explain()` to visualize model predictions using SHAP.
